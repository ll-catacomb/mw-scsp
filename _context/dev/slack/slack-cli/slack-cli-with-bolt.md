...
You can use the Slack CLI to streamline development of apps using [Bolt for JavaScript](https://api.slack.com/tools/bolt-js) and [Bolt for Python](https://api.slack.com/tools/bolt-python).

To create a Bolt app using features currently under development, refer to the [experiments](https://api.slack.com/tools/slack-cli/reference/experiments) page.
...
For more information, refer to [Getting started with Bolt for Python](https://api.slack.com/tools/bolt-python/getting-started).
